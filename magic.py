...
magic = [
  ...
  [0, 'string', '=', b'\211LZO\000\015\012\032\012', 'application/data'],
  ...
  [7, 'string', '=', b'\357\020\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000', 'application/core'],
  ...
  [0, 'string', '=', b"(SYSTEM::VERSION '", 'CLISP byte-compiled Lisp program text'],
  ...
  [128, 'string', '=', b'PE\000\000', 'MS Windows PE'],
  ...
  [8, 'string', '=', b'\001s SCCS', 'archive data'],
  ...
  [2, 'string', '=', b'\000\021', 'font/x-tex-tfm'],
  [2, 'string', '=', b'\000\022', 'font/x-tex-tfm'],
  ...
  [0, 'string', '=', b'\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\002\000', 'old timezone data'],
  [0, 'string', '=', b'\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\003\000', 'old timezone data'],
  [0, 'string', '=', b'\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\004\000', 'old timezone data'],
  [0, 'string', '=', b'\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\005\000', 'old timezone data'],
  [0, 'string', '=', b'\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\006\000', 'old timezone data'],
  ...
  [596, 'string', '=', b'X\337\377\377', 'Ultrix core file'],
  ...
  if n[:2] == '0x':
    ...
    while len(n) > 0:
      ...
      if ord(l) < 48 or ord(l) > 57: 
        raise Exception("invalid octal digit")
      val = val + int(l) * col
      col = col * 8
      n = n[:len(n)-1]
  else:
...
class magicTest:
  ...
  def compare(self, data):
    #print(self.type, "/", self.value, "@", self.offset, "->", self.msg)
    try: 
      if self.type == 'string':
        data = data[self.offset:self.offset+len(self.value)]
...
def whatis(data):
  ...
  if data.find(b'The') > -1:
    return 'English text'
  if data.find(b'import ') > -1:
